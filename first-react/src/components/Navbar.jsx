  ...
  return (
    ...
    <nav className={`navbar navbar-expand-lg navbar-${props.mode === 'dark' ? 'dark' : 'light'} bg-${props.mode === 'dark' ? 'dark' : 'light'}`}>
      <div className="container-fluid">
        ...
        <div className={`collapse navbar-collapse-${props.mode === 'light' ? 'dark' : 'light'}`} id="navbarSupportedContent" >
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <a className="nav-link active" aria-current="page" href="/">Home</a>
            </li>
            <li className="nav-item">
              <a className={`navbar-brand text-${props.mode === 'dark' ? 'white' : 'dark'}`} href="/" >{props.aboutText}</a>
            </li>
          </ul>
        </div>
