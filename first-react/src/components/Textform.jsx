  ...
  <div className="mb-3">
    ...
    <textarea className="form-control" onChange={HandleOnChange} style={{backgroundColor:props.mode==='dark'?'#333':'white',
      color:props.mode==='dark'?'white':'black' }} id="my-Box" value={text}  rows="10"></textarea>
  </div>
